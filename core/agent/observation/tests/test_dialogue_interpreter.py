...
import pytest
from core.agent.observation.surface_relation_extractor import SurfaceRelationExtractor
from core.agent.observation.interpretation_generator import InterpretationGenerator
from core.agent.observation.dialogue_interpreter import DialogueInterpreter
from core.agent.observation.models import DomainObservation
...
class TestDialogueInterpreter:
    def test_interpret_basic(self):
        from core.agent.tiered.action_resolver import TieredActionResolver
        from core.agent.observation.dialogue_domain_adapter import create_dialogue_adapter
