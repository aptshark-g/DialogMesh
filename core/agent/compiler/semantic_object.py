...
class LOD:
    ...
    def from_horizon(cls, horizon) -> "LOD":
        ...
        from core.agent.compiler.perspective_planner import Horizon
...
from core.agent.state.state_object import StateObject, Lifespan, Transition, TransitionReason, StateDelta
