...
# ── v3 backward-compat aliases (generated by CLI registry bridge) ──

class GenerateRequest_v3(GenerateRequest):
    """v3 extended request."""
    json_schema: dict = None


class GenerateResult_v3(GenerateResult):
    """v3 extended result."""
    pass
...
class LLMProvider_v3(LLMProvider):
    """v3 extended provider (backward-compatible alias)."""
    pass
