...
DOT_ALIASES: dict[str, str] = {
    ...
    # Tiered pipeline thresholds (v4)
    "negative_kb.keyword_threshold": "negative_kb_keyword_threshold",
    "negative_kb.fuse_threshold": "negative_kb_fuse_threshold",
    "intent.rule_threshold": "intent_rule_threshold",
    "intent.llm_threshold": "intent_llm_threshold",
...
STRATEGY_PRESETS: dict[str, dict[str, float]] = {
    ...
    "conservative": {
        ...
        "sim_threshold": 0.78,
        # v4 tiered pipeline
        "negative_kb_keyword_threshold": 0.90,
        "negative_kb_fuse_threshold": 0.80,
        "intent_rule_threshold": 0.65,
        "intent_llm_threshold": 0.55,
    ...
    "aggressive": {
        ...
        # v4 tiered pipeline
        "negative_kb_keyword_threshold": 0.75,
        "negative_kb_fuse_threshold": 0.60,
        "intent_rule_threshold": 0.55,
