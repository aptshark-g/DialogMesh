...
def _dispatch_p3(args):
    ...
    from core.agent.cli.commands.p3_cmd import (
        ...
        cmd_behavior_search, cmd_behavior_export, cmd_behavior_filter,
        cmd_meta_show, cmd_meta_review,
        cmd_meta_audit, cmd_meta_verify, cmd_meta_stats,
        cmd_meta_queue, cmd_meta_decisions, cmd_meta_accuracy,
        cmd_assoc_show, cmd_assoc_trace,
        cmd_assoc_funnel, cmd_assoc_stats, cmd_assoc_filter,
        cmd_assoc_search, cmd_assoc_export, cmd_assoc_history,
    ...
    map = {
        ...
        ("behavior","search"): cmd_behavior_search, ("behavior","export"): cmd_behavior_export,
        ("behavior","filter"): cmd_behavior_filter,
        ...
        ("meta","accuracy"): cmd_meta_accuracy,
        ...
        ("assoc","search"): cmd_assoc_search, ("assoc","export"): cmd_assoc_export,
        ("assoc","history"): cmd_assoc_history,
...
def _dispatch_p4(args):
    ...
    from core.agent.cli.commands.p4_cmd import (
        ...
        cmd_profile_sessions, cmd_profile_stability,
    ...
    m = {
        ...
        ("profile","sessions"): cmd_profile_sessions, ("profile","stability"): cmd_profile_stability,
...
def main():
    ...
    if fn:
        ...
        about = getattr(args, "subcommand", "")
        from core.agent.cli.commands.blueprint_cmd import cmd_blueprint_show as bs, cmd_blueprint_build as bb, cmd_blueprint_validate as bv, cmd_blueprint_export as bex, cmd_blueprint_build_hybrid as bh, cmd_blueprint_build_llm as bl, cmd_blueprint_history as bhi, cmd_blueprint_analyze as ba, cmd_blueprint_template_list as btl, cmd_blueprint_clear as bc
        {"show": bs, "build": bb, "validate": bv, "export": bex,
         "build-hybrid": bh, "build-llm": bl, "history": bhi,
         "analyze": ba, "template-list": btl, "clear": bc}.get(about, lambda a: print("dm blueprint <...>"))(args)
