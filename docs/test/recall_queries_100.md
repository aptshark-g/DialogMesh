...
|---|---|---|---|---|
| c001 | 如果想做一个pi一样的agent你会怎么做？ | goldset:r000,r001,r002,r003,r004,r005,r006,r007,r008 | dialogue | b84e1b45-4f5 |
| c002 | 去看看pi的信息，openclaw的原型貌似是，去查一下 | goldset:r009,r010,r011 | dialogue | 6c37deb1-3c7 |
| c003 | 你现在可以做编排吗？有那些内容是你可以操作的？ | goldset:r012,r013,r014 | dialogue | 46f894d8-2cf |
| c004 | 试试看任务编排，你规划一个，设计里面我是可以改的吧？ | goldset:r015,r016,r017,r018 | dialogue | 46f894d8-2cf |
| c005 | 你是无法去做任务规划吗？直接给一个完整的检验任务规划，系统会去做吧？ | goldset:r019,r020,r021,r022 | dialogue | 46f894d8-2cf |
| c006 | 你可以直接规划刀任务的吧？就用你发的这个 | goldset:r023,r024,r025,r026 | dialogue | 46f894d8-2cf |
| c007 | 你不能直接加载到任务里面吗？ | goldset:r027,r028,r029,r030 | dialogue | 46f894d8-2cf |
| c008 | 现在可以去规划了吧？ | goldset:r031 | dialogue | 46f894d8-2cf |
| c009 | 没显示什么情况 | goldset:r032,r033 | dialogue | 46f894d8-2cf |
| c010 | 帮我规划一个代码审查任务 | goldset:r034,r035,r036,r037,r038,r039,r040,r041,r042 | dialogue | demo |
| c011 | 你现在来规划一个东西，然后给我规划图 | goldset:r043,r044,r045,r046 | dialogue | a9c84948-bc1 |
| c012 | 我改了你能看到吗？ | goldset:r047 | dialogue | a9c84948-bc1 |
| c013 | 现在我改了你收到了？ | goldset:r048 | dialogue | a9c84948-bc1 |
| c014 | 帮我规划一个用户登录系统 | goldset:r049,r050,r051,r052,r053 | dialogue | a9c84948-bc1 |
| c015 | 有上下文吗？ | goldset:r054,r055 | dialogue | a9c84948-bc1 |
| c016 | 规划一个用户登录系统，包含注册、JWT认证、密码找回 | goldset:r056,r057,r058,r059,r060,r061,r062,r063 | dialogue | aaf0c679-727 |
| c017 | 规划一个用户登录系统 | goldset:r064,r065,r066 | dialogue | 45bda4aa-4a8 |
| c018 | 你现在所知的上下文有什么 | goldset:r067 | dialogue | a40bd2e8-d8f |
| c019 | 设计一个用户登录系统，包含JWT认证和数据库设计 | goldset:r068,r069,r070,r071,r072,r073,r074,r075,r076,r077,r078,r079,r080,r081,r082,r083,r084 | dialogue | 7b509b3d-718 |
| c020 | 简短说一下JWT和Session的区别 | goldset:r085,r086,r087 | dialogue | ef309875-81e |
| c021 | 我是一个喜欢探索新技术的软件工程师 | goldset:r088,r089,r090 | dialogue | b0c37811-c90 |
| c022 | 设计一个全新的探索性系统架构，我计划分步骤实现，先验证核心模式 | goldset:r091,r092,r093 | dialogue | fe3a7a79-517 |
| c023 | 简述微服务架构的优势 | goldset:r094,r095,r096 | dialogue | 0b3d2455-f2c |
| c024 | 审计测试：微服务架构的优缺点 | goldset:r097,r098,r099,r100 | dialogue | 5d3bd6ef-9ac |
| c025 | 设计用户登录系统的JWT认证方案 | goldset:r101,r102,r103,r104,r105 | dialogue | 6f78417d-35f |
| c026 | PostgreSQL数据库选型对比MySQL | goldset:r106,r107,r108,r109,r110,r111,r112 | dialogue | 6f78417d-35f |
| c027 | 设计一个全新的探索性系统架构，我计划分步骤验证核心模式，需要规范化的流程和明确的测试标准 | goldset:r113,r114,r115,r116,r117,r118 | dialogue | 08da846a-ecf |
| c028 | 设计全新探索性系统架构，计划分步骤验证核心模式，需要规范化流程和明确测试标准 | goldset:r119,r120,r121,r122 | dialogue | 272507a7-e86 |
| c029 | 设计一个用户认证系统，需要规范流程和明确测试标准 | goldset:r123,r124,r125,r126,r127,r128,r129,r130,r131 | dialogue | 216aa648-491 |
| c030 | 我叫小明，我的项目是DialogMesh | goldset:r132,r133 | dialogue | ba35e8f4-f1a |
| c031 | 我叫什么名字？我的项目是什么？ | goldset:r134 | dialogue | ba35e8f4-f1a |
| c032 | 帮我分析一下这个系统的架构设计，网关和状态机的关系是什么 | goldset:r135,r136,r137,r138,r139,r140,r141,r142 | dialogue | abfd3223-a16 |
| c033 | 帮我规划一个用户登录系统的JWT认证方案 | goldset:r143,r144,r145,r146,r147,r148,r149,r150,r151,r152,r153,r154,r155,r156,r157 | dialogue | 4ac03ef9-61d |
| c034 | 刚才的方案里 JWT 有效期怎么设置比较合理？ | goldset:r158,r159,r160,r161,r162,r163 | dialogue | 4ac03ef9-61d |
| c035 | 你好,介绍一下你自己 | goldset:r164,r165 | dialogue | 64d2ce82-857 |
| c036 | 修改 core/agent/recall 下的召回服务，把 bm25 权重提高 | goldset:r166 | dialogue | d63676dc-8af |
| c037 | 写一份关于统一召回方案的简短设计文档，保存到 data/demo_recall_doc.md | goldset:r167,r168,r169,r170,r171 | dialogue | 2cd98b6a-8db |
| c038 | 写一个 hello.py 打印 Hello DialogMesh，并运行它，告诉我输出。 | goldset:r172,r173,r174,r175,r176 | dialogue | b4ea43d2-a1e |
| c039 | 写一个 Python 脚本计算 1 到 100 的质数之和并运行验证，然后告诉我结果。 | goldset:r177,r178,r179,r180 | dialogue | 0acd4a82-522 |
| q001 | 执行层怎么分层？tool_loop 和蓝图、元认知是什么关系 | docs/only/blueprint/EXECUTION_LAYER_ARCHITECTURE_20260809.md | simple | 三层架构定案 |
| q002 | agentic 工具节点怎么让 LLM 自己调工具 | docs/only/execution/V2_EXECUTION_LAYER_IMPL_20260809.md; docs/only/blueprint/EXECUTION_LAYER_ARCHITECTURE_20260809.md | simple | agentic 节点语义 |
...
| q027 | v2.1 召回桥之后下一个施工项是什么 | docs/only/STATE_HANDOFF_20260809.md; docs/only/STATE_HANDOFF_RECALL_COMPLETE_20260812.md | simple | 交接 |
...
| q031 | 执行层监控 Hot Warm Cold 分别做什么 | docs/only/execution/V2_EXECUTION_LAYER_IMPL_20260809.md | simple | 三层监控 |
...
| q035 | 蒸馏原料管道怎么收集，HeuristicDistiller 从哪拿数据 | docs/only/wise/HEURISTIC_DISTILLATION_IMPL_20260807.md | complex | 蒸馏 |
| q036 | 技能生命周期怎么做活性管理的 | docs/only/blueprint/LEARNING_CLOSED_LOOP_IMPL_20260806.md; docs/only/wise/HEURISTIC_DISTILLATION_IMPL_20260807.md | complex | skill lifecycle |
...
| q052 | 隐式关系候选怎么生成和核验，precision 多少 | docs/only/recall/CONTENT_TO_GRAPH_20260811.md; docs/only/STATE_HANDOFF_RECALL_COMPLETE_20260812.md | complex | 隐式边核验 |
...
| q057 | 存储分层 H/W/C/A 怎么升降，阈值多少 | docs/only/G10_STORAGE_DECISION_20260803.md; docs/only/discourse_tree/TREE_TIERING_DECISION_20260807.md | complex | 存储分层 |
